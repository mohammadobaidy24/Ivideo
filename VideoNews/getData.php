...
$video_per_page = 18; // تعداد ویدیو ها برای نمایش بعدی 
 // Select The news Between Showed Videos and Number of Items To Show  انتخاب اخبار ها بعد از تعداد نمایش داده شده           
$S_F_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') ORDER BY `Timestamp` desc limit  " . $showed_videos . "," . $video_per_page);
