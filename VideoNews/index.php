...
$Path =  'VideoNews/index.php';  //آدرس صفحه 
?>
<!DOCTYPE html> <!-- HTML 5 -->
<html lang="utf-8">
<!-- آغاز HTML -->
...
<head>
    <!--  Head آغاز-->
    <title>اخبار - iVideo</title> <!-- عنوان صحفه -->
    <?php
                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="#"><i class="fa fa-mortar-board"> </i> اخبار</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>اخباری مرسوم</h2> <!-- عنوان اخباری مرسوم -->
                    </div>
                </div>
            </div>
            <div class="row trending__filter">
                <?php
                // Select Trending Newss انتخاب اخباری مرسوم
                $S_T_E = mysqli_query($DB_config, "SELECT * FROM `trending` WHERE (`Kind` = 'اخبار') ORDER BY `Timestamp` desc limit 8 ");
                while ($S_T_E_row = mysqli_fetch_array($S_T_E)) { // While data of Select Trending Newss 
                    $S_T_E_Video_ID = $S_T_E_row['Video_id']; // ای دی ویدیو های مرسوم در جدول مرسوم ها
                    // Select Trending Newss From Videos Table انتخاب اخباری مرسوم در جدول ویدیو ها 
                    $S_T_E_from_Videos = mysqli_query($DB_config, "SELECT * from videos WHERE (`ID` = " . $S_T_E_Video_ID . ")");
                    while ($S_T_E_row = mysqli_fetch_array($S_T_E_from_Videos)) { // While data of Select Trending Newss From Video Table
                ...
                <?php
                    }  // Select Trending Newss From Video Table While Ends
                } // Select Trending Newss While Ends
                ?>
            </div> <!-- row Ends -->
        </div> <!-- Container Ends -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar__item">
                            ...
                            <ul class="list">
                                <?php
                                // Select Authors Of News انتخاب تدریس کننده های ویدیو های اخبار
                                $S_A_E = mysqli_query($DB_config, "SELECT DISTINCT(Author) As Author from videos WHERE (`Kind` = 'اخبار') order by Author");
                                while ($S_A_E_row = mysqli_fetch_array($S_A_E)) {
                                    $S_A_E_Author = $S_A_E_row['Author']; // تدریس کننده گان 
                                    ?>
                                    <li>
                                        <!-- List The News Authors -->
                                        <a href="../Search/search.php?search=<?= $S_A_E_Author ?>">
                                            <i class="fa fa-book"> </i>
                                            <?= $S_A_E_Author ?>
                                        </a>
                                    </li>
                                <?php } // Select Authors Of News While End 
                                ?>
                            </ul>
                            ...
                            <div class="simple-list__text ">
                                ...
                                <div class="simple-list__slider owl-carousel ">
                                    ...
                                    <div class="simple-list__slider__item">
                                        <!-- Slider اولی -->
                                        <?php
                                        // Select Latest Newss انتخاب آخرین اخبار 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') ORDER BY `Timestamp` desc limit 5 ");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین اخبار 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین اخبار
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین اخبار
                                            $S_L_E_Author = $S_L_E_row['Author'];  //  تدریس کننده آخرین اخبار
                                            $S_L_E_Subject = $S_L_E_row['Subject'];  //   موضوع آخرین اخبار
                                            $S_L_E_Owner = $S_L_E_row['Owner'];  //  صاحب آخرین اخبار
                                            $S_L_E_Kind = $S_L_E_row['Kind'];  //   نوعیت آخرین اخبار
                                            $S_L_E_Thumbnail = "../DB/$S_L_E_Kind/$S_L_E_Subject/$S_L_E_Author/$S_L_E_Name.jpg";  //  تصویر آخرین اخبار
                                    ...
                                    <div class="simple-list__slider__item">
                                        ...
                                        <?php
                                        // Select Latest Newss انتخاب آخرین اخبار 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') ORDER BY `Timestamp` desc limit 5 offset 5");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین اخبار 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین اخبار
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین اخبار
                                    ...
                                    <div class="simple-list__slider__item">
                                        ...
                                        <?php
                                        // Select Latest Newss انتخاب آخرین اخبار 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') ORDER BY `Timestamp` desc limit 5 offset 10");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین اخبار 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین اخبار
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین اخبار
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="all_videos__section">
                        ...
                        <div class="row">
                            <div class="all_videos__slider owl-carousel">
                                <?php
                                // Select Best News انتخاب بهترین اخبار 
                                ...
                                while ($S_B_E_row = mysqli_fetch_array($S_B_E)) {
                                    ...
                                    // Select Best News From Videos Table انتخاب بهترین اخبار از جدول ویدیو ها 
                                    $S_B_E_Items = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') and  (`ID` =" . $S_B_E_id . ")  ");
                                    while ($S_B_E_Items_row = mysqli_fetch_array($S_B_E_Items)) {
                                        $S_B_E_Items_ID = $S_B_E_Items_row['ID']; //  آی دی بهترین اخبار
                                        $S_B_E_Items_Name = $S_B_E_Items_row['Name']; //  نام فایل بهترین اخبار
                                        $S_B_E_Items_Title = $S_B_E_Items_row['Title']; //  عنوان بهترین اخبار
                                        $S_B_E_Items_Author = $S_B_E_Items_row['Author']; //  تدریس کننده بهترین اخبار
                                        $S_B_E_Items_Subject = $S_B_E_Items_row['Subject']; //  موضوع بهترین اخبار
                                        $S_B_E_Items_Kind = $S_B_E_Items_row['Kind']; //  نوعیت بهترین اخبار
                                        $S_B_E_Items_Tumbnail = "../DB/$S_B_E_Items_Kind/$S_B_E_Items_Subject/$S_B_E_Items_Author/$S_B_E_Items_Name.jpg"; // تصویر بهترین اخبار
                                        ?>
                                        <div class="col-lg-4 ">
                                            <!-- Bootstrap Columns -->
                                ...
                                <?php }   // Select Best News From Videos Table While End
                                } // Select Best News While End
                                ?>
                            </div>
                    ...
                    <div class="filter__item">
                        ...
                        <div class="section-title">
                            <h2>تمام اخبار</h2><!-- عنوان بهترین ویدیو ها  -->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <?php // Select All Of News In Database انتخاب تمام اخبار در دیتابیس 
                                    $S_A_E_V = mysqli_query($DB_config, "SELECT ID from videos WHERE (`Kind` = 'اخبار')");
                            ...
                            <div class="col-lg-4 col-md-3">
                                <div class="filter__text">
                                    <span> بخاطریکه هیچگاه زنده گی اخبار را متوقف نمیکند.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        $video_per_page = 18;
                        // حساب تمام اخبار در دیتابیس 
                        $C_T_E  = mysqli_query($DB_config, "SELECT count(*) as allcount FROM videos WHERE (`Kind` = 'اخبار')");
                        $C_T_E_fetch = mysqli_fetch_array($C_T_E);
                        $C_T_E_allcount =  $C_T_E_fetch['allcount'];
                        // Select First 18 Newss انتخاب ویدیو اولیه  
                        $S_F_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'اخبار') order by Rand() limit 0,$video_per_page ");
                        ...
                        <?php } // Select First 18 Newss While Ends 
                        ?>
                        <div class="col-lg-12 ">
                            <!-- Bootstrap Columns -->
