...
<head>
    <title>اخبار - iVideo</title> <!-- عنوان صفحه -->
    <?php
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="simple-info">
                        ...
                        <div class="section-title ">
                            <h2>آخرین اخبار</h2> <!-- عنوان بهترین ویدیو ها  -->
						</div>
						<div class="row">
						<div class="col-lg-6">
						<?php
                                        // Select Latest Songs انتخاب آخرین آهنگ ها 
                                        $S_L_V = mysqli_query($DB_config, "SELECT * from videos where `kind`= 'اخبار' ORDER BY `Timestamp` desc limit 20 ");
						...
						<?php
                                        // Select Latest Songs انتخاب آخرین آهنگ ها 
                                        $S_L_V = mysqli_query($DB_config, "SELECT * from videos where `kind`= 'اخبار' ORDER BY `Timestamp` desc limit 20 offset 20 ");
                                        while ($S_L_V_row = mysqli_fetch_array($S_L_V)) {
                                            $S_L_V_ID = $S_L_V_row['ID'];  // آی دی آخرین آهنگ ها 
                                            $S_L_V_Name = $S_L_V_row['Name'];  //  نام ویدیو آخرین آهنگ ها
                                            $S_L_V_Title = $S_L_V_row['Title'];  // عنوان آخرین آهنگ ها
