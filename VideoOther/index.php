<!-- 
    نمایه سرگرمی ها  
    خانه / VideoEntertanment / 
-->
<?php
include '../tools/DB_config.php'; //   فایل ارتباط با دیتابیس
$Path =  'VideoOther/index.php';  //آدرس صفحه 
?>
<!DOCTYPE html> <!-- HTML 5 -->
<html lang="utf-8">
<!-- آغاز HTML -->
...
<head>
    <!--  Head آغاز-->
    <title>سرگرمی ها - iVideo</title> <!-- عنوان صحفه -->
    <?php
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <h2>ویدیو های سرگرمی</h2>
                        <div class="breadcrumb__option">
                            <a href="../index.php"><i class="fa fa-home"> </i> خانه</a>
                            <a href="#"><i class="fa fa-mortar-board"> </i> سرگرمی</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- آغاز سرگرمی های مرسوم  -->
    <section class="trending spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>سرگرمی های مرسوم</h2> <!-- عنوان سرگرمی های مرسوم -->
                    </div>
                </div>
            </div>
            <div class="row trending__filter">
                <?php
                // Select Trending Entertanments انتخاب سرگرمی های مرسوم
                $S_T_E = mysqli_query($DB_config, "SELECT * FROM `trending` WHERE (`Kind` = 'سرگرمی') ORDER BY `Timestamp` desc limit 8 ");
                while ($S_T_E_row = mysqli_fetch_array($S_T_E)) { // While data of Select Trending Entertanments 
                    $S_T_E_Video_ID = $S_T_E_row['Video_id']; // ای دی ویدیو های مرسوم در جدول مرسوم ها
                    // Select Trending Entertanments From Videos Table انتخاب سرگرمی های مرسوم در جدول ویدیو ها 
                    $S_T_E_from_Videos = mysqli_query($DB_config, "SELECT * from videos WHERE (`ID` = " . $S_T_E_Video_ID . ")");
                    while ($S_T_E_row = mysqli_fetch_array($S_T_E_from_Videos)) { // While data of Select Trending Entertanments From Video Table
                ...
                <?php
                    }  // Select Trending Entertanments From Video Table While Ends
                } // Select Trending Entertanments While Ends
                ?>
            </div> <!-- row Ends -->
        </div> <!-- Container Ends -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar__item">
                            ...
                            <ul class="list">
                                <?php
                                // Select Authors Of Entertanment انتخاب تدریس کننده های ویدیو های سرگرمیی
                                $S_A_E = mysqli_query($DB_config, "SELECT DISTINCT(Author) As Author from videos WHERE (`Kind` = 'سرگرمی') order by Author");
                                while ($S_A_E_row = mysqli_fetch_array($S_A_E)) {
                                    $S_A_E_Author = $S_A_E_row['Author']; // تدریس کننده گان 
                                    ?>
                                    <li>
                                        <!-- List The Entertanment Authors -->
                                        <a href="../Search/search.php?search=<?= $S_A_E_Author ?>">
                                            <i class="fa fa-film"> </i>
                                            <?= $S_A_E_Author ?>
                                        </a>
                                    </li>
                                <?php } // Select Authors Of Entertanment While End 
                                ?>
                            </ul>
                            ...
                            <div class="simple-list__text ">
                                ...
                                <div class="simple-list__slider owl-carousel ">
                                    ...
                                    <div class="simple-list__slider__item">
                                        <!-- Slider اولی -->
                                        <?php
                                        // Select Latest Entertanments انتخاب آخرین سرگرمی ها 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی') ORDER BY `Timestamp` desc limit 5 ");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین سرگرمی ها 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین سرگرمی ها
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین سرگرمی ها
                                            $S_L_E_Author = $S_L_E_row['Author'];  //  تدریس کننده آخرین سرگرمی ها
                                            $S_L_E_Subject = $S_L_E_row['Subject'];  //   موضوع آخرین سرگرمی ها
                                            $S_L_E_Owner = $S_L_E_row['Owner'];  //  صاحب آخرین سرگرمی ها
                                            $S_L_E_Kind = $S_L_E_row['Kind'];  //   نوعیت آخرین سرگرمی ها
                                            $S_L_E_Thumbnail = "../DB/$S_L_E_Kind/$S_L_E_Subject/$S_L_E_Author/$S_L_E_Name.jpg";  //  تصویر آخرین سرگرمی ها
                                        ...
                                        <?php
                                        } // Select Latest Entertanments While End
                                        ?>
                                    </div>
                                    <!-- آغاز بخش Slider -->
                                    <div class="simple-list__slider__item">
                                        ...
                                        <?php
                                        // Select Latest Entertanments انتخاب آخرین سرگرمی ها 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی') ORDER BY `Timestamp` desc limit 5 OFFSET 5");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین سرگرمی ها 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین سرگرمی ها
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین سرگرمی ها
                                    ...
                                    <div class="simple-list__slider__item">
                                        ...
                                        <?php
                                        // Select Latest Entertanments انتخاب آخرین سرگرمی ها 
                                        $S_L_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی') ORDER BY `Timestamp` desc limit 5 OFFSET 10 ");
                                        while ($S_L_E_row = mysqli_fetch_array($S_L_E)) {
                                            $S_L_E_ID = $S_L_E_row['ID'];  // آی دی آخرین سرگرمی ها 
                                            $S_L_E_Name = $S_L_E_row['Name'];  //  نام ویدیو آخرین سرگرمی ها
                                            $S_L_E_Title = $S_L_E_row['Title'];  // عنوان آخرین سرگرمی ها
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="all_videos__section">
                        ...
                        <div class="row">
                            <div class="all_videos__slider owl-carousel">
                                <?php
                                // Select Best Entertanment انتخاب بهترین سرگرمی ها 
                                ...
                                while ($S_B_E_row = mysqli_fetch_array($S_B_E)) {
                                    ...
                                    // Select Best Entertanment From Videos Table انتخاب بهترین سرگرمی ها از جدول ویدیو ها 
                                    $S_B_E_Items = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی') and  (`ID` =" . $S_B_E_id . ")  ");
                                    while ($S_B_E_Items_row = mysqli_fetch_array($S_B_E_Items)) {
                                        $S_B_E_Items_ID = $S_B_E_Items_row['ID']; //  آی دی بهترین سرگرمی ها
                                        $S_B_E_Items_Name = $S_B_E_Items_row['Name']; //  نام فایل بهترین سرگرمی ها
                                        $S_B_E_Items_Title = $S_B_E_Items_row['Title']; //  عنوان بهترین سرگرمی ها
                                        $S_B_E_Items_Author = $S_B_E_Items_row['Author']; //  تدریس کننده بهترین سرگرمی ها
                                        $S_B_E_Items_Subject = $S_B_E_Items_row['Subject']; //  موضوع بهترین سرگرمی ها
                                        $S_B_E_Items_Kind = $S_B_E_Items_row['Kind']; //  نوعیت بهترین سرگرمی ها
                                        $S_B_E_Items_Tumbnail = "../DB/$S_B_E_Items_Kind/$S_B_E_Items_Subject/$S_B_E_Items_Author/$S_B_E_Items_Name.jpg"; // تصویر بهترین سرگرمی ها
                                        ?>
                                        <div class="col-lg-4 ">
                                            <!-- Bootstrap Columns -->
                                ...
                                <?php }   // Select Best Entertanment From Videos Table While End
                                } // Select Best Entertanment While End
                                ?>
                            </div>
                    ...
                    <div class="filter__item">
                        ...
                        <div class="section-title">
                            <h2>تمام سرگرمی ها</h2><!-- عنوان بهترین ویدیو ها  -->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <?php // Select All Of Entertanment In Database انتخاب تمام سرگرمی ها در دیتابیس 
                                    $S_A_E_V = mysqli_query($DB_config, "SELECT ID from videos WHERE (`Kind` = 'سرگرمی')");
                                    $S_A_E_V_Result = mysqli_num_rows($S_A_E_V); // تعداد آنوزش ها 
                                    ?>
                                    <span class="badge badge-dark"><?= $S_A_E_V_Result ?> </span>
                                    <h6> تعداد سرگرمی ها</h6>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-3">
                                <div class="filter__text">
                                    <span> بخاطریکه هیچگاه زنده گی سرگرمی را متوقف نمیکند.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        $video_per_page = 18;
                        // حساب تمام سرگرمی ها در دیتابیس 
                        $C_T_E  = mysqli_query($DB_config, "SELECT count(*) as allcount FROM videos WHERE (`Kind` = 'سرگرمی')");
                        $C_T_E_fetch = mysqli_fetch_array($C_T_E);
                        $C_T_E_allcount =  $C_T_E_fetch['allcount'];
                        // Select First 18 Entertanments انتخاب ویدیو اولیه  
                        $S_F_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی') order by Rand() limit 0,$video_per_page ");
                        ...
                        <?php } // Select First 18 Entertanments While Ends 
                        ?>
                        <div class="col-lg-12 ">
                            <!-- Bootstrap Columns -->
