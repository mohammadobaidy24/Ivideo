...
// Select The Entertainment Between Showed Videos and Number of Items To Show  انتخاب آموزش ها بعد از تعداد نمایش داده شده           
$S_F_E = mysqli_query($DB_config, "SELECT * from videos WHERE (`Kind` = 'سرگرمی')  ORDER BY `Timestamp` desc limit  " . $showed_videos . "," . $video_per_page);
